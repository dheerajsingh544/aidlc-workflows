...
We're excited to announce the general availability of AI-DLC Workflows 2.0. The new version makes autonomous software development practical by turning AI agents into verifiable, self-correcting engineering workflows. You can read the [full specification here](https://github.com/awslabs/aidlc-workflows/blob/v2/assets/AI-DLC-Workflows-2.0-Specification.pdf) and check the [v2 branch](https://github.com/awslabs/aidlc-workflows/tree/v2). We would love to hear from you, and your feedback will continue to shape its direction. If you have suggestions, please reach out or interact with us on the repository.
...
2. Ask Codex: For existing project - "Using AI-DLC analyze the project?" or for new project "Using AI-DLC,  what workflow do you see?" .
